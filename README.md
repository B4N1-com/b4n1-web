...
<p align="center">
  ...
  <a href="https://github.com/B4N1-com/b4n1-web/releases/tag/v0.8.0"><img src="https://img.shields.io/github/v/release/B4N1-com/b4n1-web?style=flat&color=green" alt="GitHub release"></a>
...
```bash
curl -sL https://github.com/B4N1-com/b4n1-web/releases/latest/download/b4n1web-v0.8.0-flat.tar.gz | tar -xz && ./b4n1web --version
```
